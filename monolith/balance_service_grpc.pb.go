...
const (
	BalanceService_GetBalance_FullMethodName = "/hub_investments.BalanceService/GetBalance"
)
...
//
// BalanceService provides balance operations
...
var BalanceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hub_investments.BalanceService",
